...
TEST(F4JumbleUnitTest, H_Personalizer) {
  std::string personalizer = "UA_F4Jumble_H";
  personalizer.push_back('\x07');
  personalizer.push_back(0);
  personalizer.push_back(0);
  ASSERT_EQ(GetHPersonalizer(7), personalizer);
}

TEST(F4JumbleUnitTest, G_Personalizer) {
  {
    std::string personalizer = "UA_F4Jumble_G";
    personalizer.push_back('\x07');
    personalizer.push_back('\x0d');
    personalizer.push_back('\x00');
    ASSERT_EQ(GetGPersonalizer(7, 13), personalizer);
  }

  {
    std::string personalizer = "UA_F4Jumble_G";
    personalizer.push_back('\07');
    personalizer.push_back('\xff');
    personalizer.push_back('\xff');
    ASSERT_EQ(GetGPersonalizer(7, 65535), personalizer);
  }
}
